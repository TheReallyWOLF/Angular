...
app.use('/uploads' , express.static('uploads')); // позволяет получать доступ к картинкам напрямую http://localhost:5000/uploads/НАЗАВАНИЕ В БАЗЕ КАРТИНКИ.jpeg по ссылке например http://localhost:5000/uploads/21102020-211620_845-517730142.jpeg
